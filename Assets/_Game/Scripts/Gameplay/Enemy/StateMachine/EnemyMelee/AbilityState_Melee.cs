...
namespace _Game.Scripts.Gameplay.Enemy.StateMachine
{
    public class AbilityState_Melee : EnemyState
    {
        ...
        public override void Exit()
        {
            ...
            enemy.anim.SetFloat(Constant.AnimationParameter.RecoveryIndex, 0);
        }
        ...
        public override void AbilityTrigger()
        {
            ...
            GameObject newAxe = ObjectPool.Instance.GetObject(enemy.axePrefabs);

            newAxe.transform.position = enemy.axeStartPoint.position;
            newAxe.GetComponent<EnemyAxe>().AxeSetup(enemy.axeFlySpeed, enemy.player.transform, enemy.aimTimer);
        }
    }
}
