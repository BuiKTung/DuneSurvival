...
namespace _Game.Scripts.Gameplay.Enemy.StateMachine
{
    public class AttackState_Melee : EnemyState
    {
        ...
        private void SetUpAttack()
        {
            ...
            enemy.anim.SetFloat(Constant.AnimationParameter.AttackAnimationSpeed, enemy.attackDataEnemyMelee.animationSpeed);
            enemy.anim.SetFloat(Constant.AnimationParameter.AttackIndex, enemy.attackDataEnemyMelee.attackIndex);
            enemy.anim.SetFloat(Constant.AnimationParameter.SlashAttackIndex, Random.Range(0, Constant.AnimationParameter.SlashAttackCount));
        ...
        {
            enemy.anim.SetFloat(Constant.AnimationParameter.RecoveryIndex, PlayerClose() ? 1 : 0);
